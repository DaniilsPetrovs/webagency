          ...
          <div className="col-12 col-lg-5 col-xl-4">
            <div className="footer-two__left">
              ...
              <div className="paragraph">
                <p>
                  Welcome to our web development agency. We specialize in helping
              ...
              <div className="section__content-cta">
                <h2>
                  <Link
                    href="mailto:thewebcosmo@gmail.com"
          ...
          <div className="col-12 col-lg-7 col-xl-7 offset-xl-1 col-xxl-5 offset-xxl-3">
            <div className="footer-two__right">
              <div className="social justify-content-start justify-content-lg-start">
                ...
                <Link href="https://x.com/thewebcosmo" target="_blank">
              ...
              <div className="footer__single-meta section__content-cta">
                <Link
                  href="https://www.google.com/maps/d/u/0/viewer?mid=1UZ57Drfs3SGrTgh6mrYjQktu6uY&hl=en_US&ll=56.971933211842014%2C24.12907345&z=11"
                  target="_blank"
                >
