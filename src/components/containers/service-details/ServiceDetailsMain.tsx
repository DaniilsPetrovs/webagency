    ...
    const ServiceDetailsMain = ({ description, about, images }: { description: string; about : string; images: string[] }) => {
      return (
          <section className="section service-details fade-wrapper">
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-12 col-xl-10">
                  <div className="service-details__slider">
                    <div className="service-details__slider-single">
                      {/*<div className="poster fade-top">*/}
                      {/*  <Image src={images[0]} alt="Service Thumbnail" width={1170} height={535} />*/}
                      {/*</div>*/}
                      <div className="details-group section__cta text-start">
                        <h3 className="title-anim">Why Us?</h3>
                        <p>{description}</p>
                      </div>
                      <div className="section__content-cta">
                        <div className="row gaper">
                          <div className="col-12 col-lg-7">
                            <div className="details-group">
                              <h3 className="title-anim">What we Offer?</h3>
                             <p>{about}</p>
                            </div>
                          </div>
                          <div className="col-12 col-lg-5">
                            <div className="poster-small">
                              <Image src={images[1]} width={450} height={283} alt="Image"/>
                            </div>
                          </div>
                        </div>
                      </div>
