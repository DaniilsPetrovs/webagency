              ...
              <span className="sub-title">
                ...
                <i className="fa-solid fa-arrow-right"></i>
                            ...
                            <div className="paragraph">
                                <p>
                                    Webcosmo is a forward-thinking web agency that specializes in crafting cutting-edge
                                    Web and Web3 solutions. From custom web development and design to advanced
                                    blockchain integrations, we provide a full suite of services. We’re passionate about building tailored solutions that empower your business to
                                    excel in the digital world.
                                    {/*Webcosmo is a forward-thinking web agency that specializes in crafting cutting-edge*/}
                                    {/*Web and Web3 solutions. From custom web development and design to advanced*/}
                                    {/*blockchain integrations, we provide a full suite of services, including crypto*/}
                                    {/*wallet development, smart contract creation, NFT collection design, Telegram app*/}
                                    {/*development, crypto payment integration, token creation, and DApps development.*/}
                                    {/*We’re passionate about building tailored solutions that empower your business to*/}
                                    {/*excel in the digital world.*/}
                                </p>
                            </div>
                            <div className="skill-wrap">
                                ...
                                <div className="skill-bar-single">
                                    <div className="skill-bar-title">
                                        <p className="primary-text">Web3 Solutions</p>
                                    </div>
                                    <div className="skill-bar-wrapper" data-percent="100%">
                                        <div className="skill-bar">
                                            <div className="skill-bar-percent">
