...
const ProjectDetailsMain: React.FC<ProjectDetailsMainProps> = ({
                                                                   projectData,
                                                               }) => {
    return (
        <section className="section project-d">
                            ...
                            <div className="roadmap-content">
                                {projectData.roadmap ? (
                                    projectData.roadmap
                                        ...
                                        .split("\n")
                                        .map((line, index) => (
                                            <p key={index} className="roadmap-line">
                                                {line.trim()}
                                            </p>
                                        ))
                                ) : (
                        ...
                        <div className="poster__slider-wrapper">
                            <div className="poster__slider-w">
                                ...
                                >
                                    <SwiperSlide>
                                        <div className="poster__slider-single">
                                            <Image src={projectData.images[0]} alt="Poster Image" width={800} height={450} />
                                        </div>
                                    </SwiperSlide>
                                </Swiper>
                            </div>
                ...
                <div className="row gaper fade-wrapper">
                    <div className="col-12 col-sm-6 col-xl-4">
                        <div className="project-d-o__single fade-top">
                            <div className="content">
                                <h5>Sectors</h5>
                                <p>{projectData.sectors}</p>
                            </div>
                            <div className="thumb">
                                <Image src={iconone} alt="Sector Icon"/>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-sm-6 col-xl-4">
                        <div className="project-d-o__single fade-top">
                            ...
                            <div className="thumb">
                                <Image src={icontwo} alt="Owner Icon"/>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-sm-6 col-xl-4">
                        <div className="project-d-o__single fade-top">
                            <div className="content">
                                <h5>Website Link</h5>
                                <Link href={projectData.projectdate}><p>{projectData.projectdate}</p></Link>
                            </div>
                            <div className="thumb">
                                <Image src={iconthree} alt="Project Date Icon"/>
                            </div>
                        </div>
                    </div>
                </div>
